...
(91, 1, 'mya', 'Mya es el club de Umbracle, con tres diferentes espacios para una experiencia completa: Main Room (house + hits), The Lobby (fiesta) y Mya Beats (urban music)', 'Av. del Professor López Piñero, Valencia', 'Cualquiera', 'Ocio', 'Fiesta', 10),
...
(94, 1, 'Flow shisha club', 'Ambiente y musica chill, idoneo para ir de relax', 'Carrer Emili Gascó Contell, Valencia', 'Cualquiera', 'Ocio', 'Chill', 15),
...
(98, 1, 'Cream', 'Situado en el antiguo Magnum , TBClub y Pacha Valencia, Cream aporta un nuevo y fresco concepto de buena música hip hop de DJ y artistas', ' C. de Sant Vicent Màrtir, Valencia', 'Cualquiera', 'Ocio', 'Fiesta', 10),
